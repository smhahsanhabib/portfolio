...
import {AiFillLinkedin, AiFillGithub, AiOutlineUnorderedList, AiFillInstagram, AiFillFacebook} from 'react-icons/ai'
            ...
            <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark slide-in-left">
                <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <Link to="/" className="d-flex align-items-center pb-1 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span className="fs-5 d-none d-sm-inline ff-jost fw-600" id='logo' style={{border:'2px solid #E94560', borderRadius:'4%', padding:"2px 2px", color:"#E94560"}}> Ahsan Habib </span>
                    </Link>
                    ...
                    <div className="dropdown pb-4 dropup">
                        ...
                        <ul className="dropdown-menu shadow" aria-labelledby="dropdownUser1">
                            <li><a className="dropdown-item text-black" href="mailto:smahsanhabib01@gmail.com" target="/blank"><MdEmail className='fs-5'/> Email</a></li>
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://github.com/smhahsanhabib" target="/blank"><AiFillGithub className='fs-5'/> Github</a></li>
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://www.linkedin.com/in/ahsan-habib-9693951a5/" target="/blank"><AiFillLinkedin className='fs-5'/> LinkedIn</a></li>
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://www.instagram.com/s_m_ahsan_habib/" target="/blank"><AiFillInstagram className='fs-5'/> Instagram</a></li>
                            
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://www.facebook.com/SMA.habib1" target="/blank"><AiFillFacebook className='fs-5'/> Facebook</a></li>
                        </ul>
                    </div>
                </div>
            </div>
